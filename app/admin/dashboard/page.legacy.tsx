/**
 * النسخة السابقة من لوحة تحكم المدير — محفوظة للرجوع إليها.
 * للاستخدام: أعد تسمية هذا الملف إلى page.tsx وأعد page.tsx الحالي إلى page.new.tsx
 * أو استبدل محتوى page.tsx بهذا الملف.
 *
 * يعتمد على: @/components/layout/dashboard-layout (النسخة القديمة)
 */
...
export default async function AdminDashboardLegacyPage() {
    ...
    <DashboardLayout user={{ id: user.id, fullName: user.fullName, roles: user.roles }}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">نظرة عامة على منصة البحث العلمي</p>
        </div>
              ...
              <Card key={kpi.label}>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    <span className="text-green-600">{kpi.change}</span> من الشهر الماضي
                  </p>
                </CardContent>
              </Card>
            );
